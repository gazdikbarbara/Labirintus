...
namespace Labirintus
{
    public partial class FormMedium : Form
    {
        ...
        private void FormMedium_Load(object sender, EventArgs e)
        {
            try
            {
                StreamReader sr = new StreamReader("Maze/maze2.txt");
                int y = 0;
        ...
        private void FormMedium_KeyDown(object? sender, KeyEventArgs e)
        {
